  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-ink/8 bg-porcelain/96 px-4 py-2.5 shadow-soft backdrop-blur-xl md:hidden">
      <div className="mx-auto grid max-w-sm grid-cols-3 gap-2">
        <a
          className="focus-ring flex min-h-[52px] flex-col items-center justify-center gap-1 rounded-xl bg-ink px-2 text-[11px] font-semibold tracking-wide text-porcelain transition hover:bg-ink/85"
          href={site.whatsapp}
        >
